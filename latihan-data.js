...
const latihanData = {
  ...
  7: {
    ...
    subLatihan: [
      ...
      {
        id: 3,
        title: "Website Wisata Travel Time",
        description: "Membuat website sederhana bertema wisata Travel Time dengan tabel untuk menampilkan destinasi dan informasi perjalanan",
        category: "Advanced",
        icon: "fa-th",
        status: "selesai",
  ...
  9: {
    ...
    subLatihan: [
      ...
      {
        id: 7,
        title: "Tugas Latihan All Frame Navigation",
        description: "Membuat website lengkap dengan navigasi frame yang menggabungkan semua halaman sebelumnya",
        category: "Navigation",
        icon: "fa-bars",
        status: "selesai",
        link: "Latihan/pertemuan 9/menu.html"
      ...
      {
        id: 8,
        title: "Tugas Membuat Portofolio",
        description: "Tugas Portofolio",
        category: "Navigation",
        icon: "fa-bars",
        status: "selesai",
        link: "index.html"
  ...
  11: {
    ...
    subLatihan: [
      ...
      {
        id: 6,
        title: "Tugas Latihan Menu Frame dengan CSS",
        description: "Membuat menu navigasi frame menggunakan CSS untuk styling dan layout modern",
        category: "Layout",
        icon: "fa-bars",
        status: "selesai",
        link: "Latihan/pertemuan 9/menu.html"
  ...
  14: {
    ...
    subLatihan: [
      ...
      },
      {
        id: 4,
        title: "Landing Page",
        description: "Membuat landing Page dengan Bootstrap",
        category: "Bootstrap",
        icon: "fa-cube",
        status: "selesai",
        link: "Latihan/pertemuan 14/index.html"
      }
    ]
  },
  15: {
